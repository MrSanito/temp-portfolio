...
import { Github, ExternalLink, Code2, Terminal, User, Trophy, Star, GitFork } from "lucide-react";
      ...
      <section className="min-h-screen flex flex-col justify-center px-6 relative overflow-hidden pt-20">
        ...
        <div className="max-w-6xl mx-auto w-full z-10">
          <motion.div 
            ...
            className="space-y-8"
          >
             <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm text-xs font-medium text-purple-300">
            ...
            <motion.h1 
              variants={fadeInUp} 
              className="text-6xl md:text-9xl font-bold tracking-tighter leading-[0.9] bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-white/50"
            >
              Building <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-indigo-500">Digital</span> Experiences.
            </motion.h1>
            
            <motion.p variants={fadeInUp} className="text-xl md:text-2xl text-muted-foreground max-w-2xl leading-relaxed">
              I'm <span className="text-white font-semibold">{profile?.name || "Nishad Vishalkumar Ramnarayan"}</span>. 
              A Full Stack Developer specializing in building exceptional digital products with modern technologies.
            </motion.p>
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap gap-4 pt-4">
              ...
              >
                View Projects <Code2 className="w-5 h-5" />
              </a>
              <a 
                href="https://github.com/MrSanito" 
                target="_blank"
                rel="noreferrer"
                className="px-8 py-4 rounded-full border border-white/10 bg-white/5 hover:bg-white/10 backdrop-blur-sm transition-all flex items-center gap-2 font-medium"
              >
